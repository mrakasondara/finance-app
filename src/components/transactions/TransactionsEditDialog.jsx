...
export function TransactionsEditDialog({ data, fetchData, setOpenDropdown }) {
  ...
  const editTransaction = async (e) => {
    ...
    const { success, message } = await FinanceAPI.updateTransaction(
      transactionData,
      id
    );
    setIsLoading(false);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] md:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Change your transaction data here. Click save when you&apos;re done.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-3">
              ...
              <Input
                ...
                name="date"
                type="date"
                value={new Date(newData?.date).toISOString().slice(0, 10)}
                onChange={handleChange}
                required
              />
            </div>
